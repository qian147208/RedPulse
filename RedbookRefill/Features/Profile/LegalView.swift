...
struct LegalView: View {
    ...
    private var privacyContent: some View {
        Group {
            section("引言") {
                """
                灵芯(以下简称"本应用"或"我们")尊重并保护您的隐私。本隐私协议旨在向您说明我们如何收集、使用、存储和保护您的个人信息。
    ...
    private var termsContent: some View {
        Group {
            section("一、服务说明") {
                """
                灵芯 是一款面向小红书创作者的 AI 辅助创作桌面工具(iPhone / iPad / Mac),提供产品库管理、AI 文案生成、笔记编辑、AI 配图与视频、历史记录管理、AI 助手对话等功能。
