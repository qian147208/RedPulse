    ...
    private var privacyContent: some View {
        Group {
            ...
            section("一、信息收集") {
                ...
                本应用采用本地优先（Local-First）架构，仅在您的设备上存储必要数据：
            ...
            section("二、数据使用") {
                """
                您存储在应用中的所有数据仅用于本地用途：管理产品库、生成和编辑笔记草稿、提供历史记录。
            ...
            section("三、数据存储与安全") {
                ...
                • AI 配置：API Key 以明文存储在设备 UserDefaults 中
            ...
            section("七、隐私政策变更") {
                """
                本隐私政策可能不定期更新。重大变更时将在应用内通知。

                版本 1.1 · 更新日期 2026-06-09
                """
            }
        }
    }
